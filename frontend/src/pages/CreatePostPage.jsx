import {
  ...
  import { useState, useRef, navigate } from "react";
  // import { useNavigate } from "react-router-dom";
  import useShowToast from '../hooks/useShowToast'; // Assuming you have a custom hook for showing toast messages
  import usePreviewImg from '../hooks/usePreviewImg'; // Custom hook for image preview
  ...
  const CreatePostPage = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      // Replace with your actual post submission logic
      try {
        ...
        >
          ...
          <form onSubmit={handleSubmit}>
            ...
            <Button
              ...
              width="full"  // Changed from `isFullWidth` to `width="full"`
            >
              Create Post
            </Button>
          </form>
